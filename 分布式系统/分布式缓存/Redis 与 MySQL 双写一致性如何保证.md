...
![图片](Redis 与 MySQL 双写一致性如何保证.assets/640-1712763743097.webp)

## **谈谈一致性**

![图片](Redis 与 MySQL 双写一致性如何保证.assets/640-1712763743054.webp)
...
![图片](Redis 与 MySQL 双写一致性如何保证.assets/640-1712763743077.webp)Cache-Aside读请求
...
![图片](Redis 与 MySQL 双写一致性如何保证.assets/640.webp)Cache-Aside写请求
...
![图片](Redis 与 MySQL 双写一致性如何保证.assets/640-1712763743220.webp)Read-Through简要流程
...
![图片](Redis 与 MySQL 双写一致性如何保证.assets/640.webp)Read-Through流程

Read-Through实际只是在**Cache-Aside**之上进行了一层封装，它会让程序代码变得更简洁，同时也减少数据源上的负载。

#### Write-Through

**Write-Through**模式下，当发生写请求时，也是由**缓存抽象层**完成数据源和缓存数据的更新,流程如下：![图片](Redis 与 MySQL 双写一致性如何保证.assets/640-1712763743097.webp)
...
![图片](Redis 与 MySQL 双写一致性如何保证.assets/640-1712763743148.webp)Write behind流程
...
![图片](Redis 与 MySQL 双写一致性如何保证.assets/640-1712763743086.webp)Cache-Aside写入流程

我们在操作缓存的时候，到底应该删除缓存还是更新缓存呢？我们先来看个例子：

![图片](Redis 与 MySQL 双写一致性如何保证.assets/640-1712763743142.webp)
...
假设有A、B两个请求，请求A做更新操作，请求B做查询读取操作。![图片](Redis 与 MySQL 双写一致性如何保证.assets/640.webp)
...
![图片](Redis 与 MySQL 双写一致性如何保证.assets/640.webp)延时双删流程
...
![图片](Redis 与 MySQL 双写一致性如何保证.assets/640-1712763743054.webp)删除缓存重试流程
...
![图片](Redis 与 MySQL 双写一致性如何保证.assets/640-1712763743087.webp)
