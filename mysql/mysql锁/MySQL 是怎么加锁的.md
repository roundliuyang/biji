...
![](MySQL 是怎么加锁的.assets/事务a加锁分析.png)
...
![](MySQL 是怎么加锁的.assets/事务a分析1.png)
...
![](MySQL 是怎么加锁的.assets/唯一索引间隙锁.drawio.png)
...
![](MySQL 是怎么加锁的.assets/唯一索引等值查询（不存在）.drawio.png)
...
![](MySQL 是怎么加锁的.assets/唯一索引范围查询大于15.drawio.png)
...
![](MySQL 是怎么加锁的.assets/范围查询大于.png)
...
![](MySQL 是怎么加锁的.assets/唯一索引范围查询大于等于15.drawio.png)
...
![](MySQL 是怎么加锁的.assets/范围查询大于等于.png)
...
![](MySQL 是怎么加锁的.assets/唯一索引范围查询小于等于6.drawio.png)
...
![](MySQL 是怎么加锁的.assets/唯一索引范围查询小于6.png)
...
![](MySQL 是怎么加锁的.assets/唯一索引范围查询小于等于5.drawio.png)
...
![](MySQL 是怎么加锁的.assets/范围查询小于等于.png)
...
![](MySQL 是怎么加锁的.assets/唯一索引范围查询小于5.drawio.png)
...
![](MySQL 是怎么加锁的.assets/唯一索引范围查询小于.png)
...
![](MySQL 是怎么加锁的.assets/非唯一索引等值查询age=25.drawio.png)

我们也可以通过 `select * from performance_schema.data_locks\G;` 这条语句来看看事务 A 加了什么锁。

输出结果如下，我这里只截取了行级锁的内容。

![](MySQL 是怎么加锁的.assets/非唯一索引等值查询age=25.png)
...
![](MySQL 是怎么加锁的.assets/非唯一索引等值查询age=25_1.png)
...
![](MySQL 是怎么加锁的.assets/非唯一索引等值查询存在.drawio.png)
...
![](MySQL 是怎么加锁的.assets/非唯一索引等值查询（存在）.png)
...
![](MySQL 是怎么加锁的.assets/非唯一索引范围查询age大于等于22.drawio.png)
...
![](MySQL 是怎么加锁的.assets/唯一索引加锁流程.jpeg)

非唯一索引加锁的流程图：

![](MySQL 是怎么加锁的.assets/非唯一索引加锁流程.jpeg)
