...
![1643877367554](Worker Thread模式：如何避免重复创建线程？.assets/1643877367554.png)
...
线程池有很多优点，例如能够避免重复创建、销毁线程池，同时能够限制创建线程的上限等等。学习完上一篇文章后你已经知道，用 Java 的 Thread 实现 Thread-Per-Message 模式难以应对高并发场景，原因就在于频繁创建、销毁 Java 线程的成本有点高，而且无限制地创建线程还可能导致应用 OOM。线程池，则恰好能解决这些问题。
...
![1643880760392](Worker Thread模式：如何避免重复创建线程？.assets/1643880760392.png)
...
![1643881519922](Worker Thread模式：如何避免重复创建线程？.assets/1643881519922.png)
