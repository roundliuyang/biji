...
![1643253441558](Java线程（下）：为什么局部变量是线程安全的？.assets/1643253441558.png)
...
![1643253636309](Java线程（下）：为什么局部变量是线程安全的？.assets/1643253636309.png)
...
![1643254134488](Java线程（下）：为什么局部变量是线程安全的？.assets/1643254134488.png)
...
![1643254280100](Java线程（下）：为什么局部变量是线程安全的？.assets/1643254280100.png)
...
方法里的局部变量，因为不会和其它线程共享，所以没有并发问题，这个思路很好，已经成为解决并发问题的一个重要技术，同时还有个响当当的名字叫线程封闭，比较官方的解释是：仅在单线程内访问的数据。由于不存在共享，所以即便不同步也不会有并发问题，性能杠杠滴。
