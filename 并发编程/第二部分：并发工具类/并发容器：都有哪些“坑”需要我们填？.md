...
我们曾经多次强调，**组合操作需要注意竞态条件问题**，例如上面提到的 addIfNotExist() 方法就包含组合操作。组合操作往在容器领域**一个容易被忽视的“坑”是用迭代器遍历容器**，例如在下面的代码中，通过迭代器遍历容器 list，对每个元素调用 foo() 方法，这就存在并发问题，这些组合的操作不具备原子往隐藏着竞态条件问题，即便每个操作都能保证原子性，也并不能保证组合操作的原子性，这个一定要注意。
...
![1643554084505](并发容器：都有哪些“坑”需要我们填？.assets/1643554084505.png)
...
![1643557848378](并发容器：都有哪些“坑”需要我们填？.assets/1643557848378.png)
...
![1643557907112](并发容器：都有哪些“坑”需要我们填？.assets/1643557907112.png)
...
![1643558120733](并发容器：都有哪些“坑”需要我们填？.assets/1643558120733.png)
...
![1643558398101](并发容器：都有哪些“坑”需要我们填？.assets/1643558398101.png)

​																				*单端阻塞队列示意图*

2.**双端阻塞队列**：其实现是 LinkedBlockingDeque。

![1643558434823](并发容器：都有哪些“坑”需要我们填？.assets/1643558434823.png)
