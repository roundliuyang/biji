...
![1658473532635](Redis 应用指南.assets/1658473532635.png)
...
>更详细的特性及原理说明请参考：[Redis 数据类型和应用](https://dunwu.github.io/db-tutorial/nosql/redis/redis-datatype.html) 
...
![1658477540159](Redis 应用指南.assets/1658477540159.png)
...
![1658479759087](Redis 应用指南.assets/1658479759087.png)
...
**如果条件允许，主服务器可以将主从服务器连接断开期间执行的写命令发送给从服务器**，从服务器只需接收并执行这些写命令，即可将主从服务器的数据库状态保持一致。 
...
>更详细的特性及原理说明请参考：[Redis 复制](https://dunwu.github.io/db-tutorial/nosql/redis/redis-replication.html)
...
> 更详细的特性及原理说明请参考：[Redis 哨兵](https://dunwu.github.io/db-tutorial/nosql/redis/redis-sentinel.html)
...
Redis 社区中有多种编程语言的客户端，可以在这里查找合适的客户端：[Redis 官方罗列的客户端清单(opens new window)](https://redis.io/clients)

redis 官方推荐的 Java Redis Client：

- [jedis (opens new window)](https://github.com/xetorthio/jedis)- 最流行的 Redis Java 客户端  
- [redisson (opens new window)](https://github.com/redisson/redisson)- 额外提供了很多的分布式服务特性，如：分布式锁、分布式 Java 常用对象（BitSet、BlockingQueue、CountDownLatch 等）
- [lettuce (opens new window)](https://github.com/lettuce-io/lettuce-core)- Spring Boot 2.0 默认 Redis 客户端
...
>💡 Redis 常用于分布式缓存，有关缓存的特性和原理请参考：[缓存基本原理(opens new window)](https://dunwu.github.io/blog/design/theory/cache-theory/)
