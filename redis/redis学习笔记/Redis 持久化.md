...
![1658552765992](Redis 持久化.assets/1658552765992.png)
...
AOF(Append Only File) 是以 **文本日志形式** 将 **所有写命令以 Redis 命令请求协议格式追加到 AOF 文件的末尾**，以此来记录数据的变化。**当****服务器重启时，会重新载入和执行 AOF 文件中的命令，就可以恢复原始的数据**。AOF 适合作为 **热备。
...
![1658554600007](Redis 持久化.assets/1658554600007.png)
...
![1658555168299](Redis 持久化.assets/1658555168299.png)
...
![1658556495375](Redis 持久化.assets/1658556495375.png)